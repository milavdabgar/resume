...
\hypersetup{
    ...
    pdfsubject={Professional Two-Page Resume},
...
\resumeItemListStart
\resumeItem{Lead comprehensive technical education across Programming in C, Microprocessor Programming, Embedded Systems, Circuit Design, Consumer Electronics, and Entrepreneurship development}
...
\resumeItem{Architected and deployed comprehensive \textbf{Next.js Academic Management System} at \href{https://gppalanpur.in/}{gppalanpur.in} with production-grade CI/CD pipeline}
\resumeItem{Developed enterprise-grade infrastructure: self-hosted Linux servers, Dockerized microservices, CI/CD pipelines, and automated backup systems}
\resumeItemListEnd
...
\resumeItem{\textbf{Diploma Programming Track:} Completed (27/27 credits, CGPA: 7.19/10) - Database Management, Data Structures \& Algorithms, Modern Application Development I \& II}
...
\begin{itemize}[leftmargin=15pt, noitemsep, topsep=2pt]
...
\begin{itemize}[leftmargin=15pt, noitemsep, topsep=2pt]
    \item 8051, PIC, AVR, STM32 Microcontrollers
    \item Arduino, Raspberry Pi, ESP8266
...
{\textbf{\href{https://github.com/milavdabgar/studio}{Smart Academic Portal}} \textit{| Next.js, React, Docker, PostgreSQL}}{2025 -- Present}
\resumeItemListStart
...
\resumeItem{Student portfolio system with LinkedIn-style public profiles, downloadable resume/CV generation, interactive newsletters, and extensive paper solutions repository}
...
\resumeProjectHeading
{\textbf{\href{https://github.com/milavdabgar/MLP-Project}{System Threat Forecaster}} \textit{| Python, Machine Learning, TensorFlow}}{2024 -- 2025}
\resumeItemListStart
...
\resumeItemListStart
\resumeItem{Enhanced platform with modern Vue.js 3 frontend and advanced Flask backend processing}
...
\resumeProjectHeading
{\textbf{FPGA Image Steganography} \textit{| FPGA, Verilog, Digital Signal Processing}}{2014 -- 2015}
\resumeItemListStart
