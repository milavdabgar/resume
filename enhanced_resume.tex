...
\resumeProjectHeading
{\textbf{Scarlett - Household Services Web Application (MAD1)} \textit{(Flask, SQLAlchemy, Flask-Security)} - \textcolor{success}{Academic Project}}{2022 -- 2023}
\resumeItemListStart
...
\resumeProjectHeading
{\textbf{Scarlett - Household Services Web Application (MAD2)} \textit{(Vue.js, Flask, PostgreSQL, Redis, Celery)} - \textcolor{success}{Academic Project}}{2023 -- 2024}
\resumeItemListStart
...
\resumeProjectHeading
{\textbf{FPGA Implementation of Image Steganography} \textit{(FPGA, Verilog, Digital Signal Processing)} - \textcolor{success}{Published Research}}{2015}
\resumeItemListStart
...
\resumeProjectHeading
{\textbf{Wireless Data Acquisition System} \textit{(Modbus Protocol, Wireless Communication, Embedded Systems)} - \textcolor{success}{R\&D Project}}{2015 -- 2016}
\resumeItemListStart
