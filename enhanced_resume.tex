...
\resumeItem{\textbf{Current Status:} 80/142 credits completed toward full degree | Active coursework in Machine Learning Practice and Business Data Management projects}
\resumeItemListEnd
...
\resumeProjectHeading
{\textbf{\href{https://github.com/milavdabgar/milav-blowfish}{Personal Blog \& Portfolio}} \textit{| Hugo, Blowfish Theme, Markdown}}{2025 -- Present}
\resumeItemListStart
...
\resumeItemListStart
\resumeItem{Developed machine learning project for system threat prediction and forecasting}
\resumeItem{Implemented data analysis and predictive modeling techniques for cybersecurity applications}
\resumeItem{Built comprehensive ML pipeline for threat detection and risk assessment}
\resumeItem{Applied advanced algorithms for pattern recognition and anomaly detection}
\resumeItemListEnd
